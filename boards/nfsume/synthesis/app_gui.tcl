...
#  } else {
    ...
    add_files -fileset constrs_1 -norecurse ../constraints/${bit_settings}
    add_files -fileset constrs_1 -norecurse ../ip_catalog/sram_mig/sram_mig/user_design/constraints/sram_mig.xdc
#  }
...
#    read_ip -files {../ip_catalog/ten_gig_eth_mac_axi_st_ip/ten_gig_eth_mac_axi_st_ip.xci} 
    ...
    read_ip -files {../ip_catalog/asfifo_144_1024/asfifo_144_1024.xci} 
    read_ip -files {../ip_catalog/ila_0/ila_0.xci} 
    read_ip -files {../ip_catalog/sram_mig/sram_mig.xci} 
#  }
